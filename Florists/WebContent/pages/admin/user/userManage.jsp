...
<body class="childrenBody">
    <blockquote class="layui-elem-quote news_search">
        <div class="layui-inline">
            <div class="layui-input-inline">
                <input type="text" value="" placeholder="请输入用户ID或者用户名" class="layui-input search_input">
            </div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/layui_admin/pageJs/UsersManage.js"></script>
</body>
</html>