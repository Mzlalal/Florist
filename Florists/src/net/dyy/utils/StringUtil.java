...
public class StringUtil {
	...
	public static boolean contains(String value, String containString) {
		return StringUtil.indexOf(value, containString) >= 0 ? false : true;
	}
	...
	public static boolean containsIgnoreCase(String value, String containString) {
		return StringUtil.contains(value.toLowerCase(),
	...
	public static String suffixesRepairZeros(String src, int length) {
		StringBuffer result = new StringBuffer("");
		int index = StringUtil.replaceEmpty(src).length();
		result.append(StringUtil.replaceEmpty(src));
		if (index < length) {
	...
	public static String idCardtoBirthday(String idCard) {
		...
		idCard = StringUtil.replaceEmpty(idCard);
		if (idCard.length() == 15) {
